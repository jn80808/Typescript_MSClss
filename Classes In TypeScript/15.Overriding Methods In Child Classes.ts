...
class Admin extends User1{
    ...
    //-----orignal method syntax from parent 
    // public greet(): string {   // --from parent method 
    //    return`hello ${this.name}`
    // }

        // Now we can change the kind of string that we are returning from within the admin class.
        // And that's how you override methods. You are basically allowed to change the output of the method, but it has to return a string and has  to match the parameters.
        // So over here I'm just going to add some additional text I am admin.
