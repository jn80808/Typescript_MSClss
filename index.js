...
const admin = new Admin1("Mark", "marker@gmail.com");
console.log(user);
console.log(admin);
//----------------------------//
// 81. SuperMethod 
...
class Admin2 extends User3 {
    isAdmin = true;
    userReporting;
    constructor(name, email, userReporting, lastname // optional to put pero just added nalang din 
    ) {
...
//And I'm going to create another user over here.
const admin2 = new Admin1("Mark", "marker@gmail.com");
const admin3 = new Admin2("Mark", "marker@gmail.com", 11);
console.log(user);
console.log(admin);
//----------------------------//
// 82.Practice Classes  
...
class Book {
    ...
    yearPublish;
    ISBN;
    constructor(title, author, ISBN, yearPublish) {
        this.title = title;
        this.ISBN = ISBN;
        this.author = author;
        if (yearPublish) {
...
class Ebook extends Book {
    fileSize;
    format;
    constructor(title, author, ISBN, fileSize, format, yearPublish) {
...
const admin4 = new Admin1("Mark", "marker@gmail.com");
const admin5 = new Admin3("Mark", "marker@gmail.com", 11);
console.log(user);
console.log(admin5);
...
class Admin5 extends User5 {
    isAdmin = true;
    userReporting;
    constructor(name, email, phone, userReporting, lastname // optional to put pero just added nalang din 
    ) {
...
// using the "this" keyword inside the child class, you can access the properties of the parent class also.
const admin6 = new Admin1("Mark", "marker@gmail.com");
const admin7 = new Admin5("Mark", "marker@gmail.com", 5645, 11);
console.log(user);
console.log(admin7);
console.log(user.name);
admin5.printName();
...
// using the "this" keyword inside the child class, you can access the properties of the parent class also.
const admin9 = new Admin6("Mark", "marker@gmail.com", 5645, 11);
user12.printPhone();
//--------------------------------------------//
...
// using the "this" keyword inside the child class, you can access the properties of the parent class also.
const admin10 = new Admin7("Mark", "marker@gmail.com", 5645, 11);
...
// using the "this" keyword inside the child class, you can access the properties of the parent class also.
const admin11 = new Admin78("Mark", "marker@gmail.com", 5645, 11);
